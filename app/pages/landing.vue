    ...
    <section class="py-16 border-y border-white/5">
      <div class="max-w-5xl mx-auto px-6 sm:px-10 text-center">
        ...
        <div class="flex flex-wrap items-center justify-center gap-x-10 gap-y-4 text-white/25">
          <span v-for="tipo in ['Gráficas', 'Comunicação Visual', 'Adesiveiros', 'Sinalização', 'Frotas e Plotagem']" :key="tipo" class="text-sm font-semibold tracking-wide">{{ tipo }}</span>
        </div>
      </div>
    </section>
...
const plans = [
  { name: 'Starter', desc: 'Para quem está começando', price: 'R$97', period: '/mês', featured: false, url: 'https://wa.me/5511940527609', cta: 'Começar grátis', items: ['Até 2 usuários', 'Orçamentos ilimitados', 'OS e kanban', 'Financeiro básico', 'Suporte via WhatsApp'] },
  { name: 'Profissional', desc: 'O mais completo', price: 'R$197', period: '/mês', featured: true, url: 'https://wa.me/5511940527609', cta: 'Começar grátis', items: ['Até 10 usuários', 'Tudo do Starter', 'Dashboard avançado', 'Consultor IA', 'Comissões e equipe', 'Relatórios PDF'] },
